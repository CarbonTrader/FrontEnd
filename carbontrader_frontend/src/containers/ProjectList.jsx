    ...
    return (
        <section className="main-container">
            <div className='textContainer'>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus, doloribus ipsa. Pariatur optio sequi perferendis, omnis debitis, inventore, est odio cupiditate placeat quibusdam error qui possimus et assumenda modi quam. </p>
            </div>

            <div className="ProjectList-container">
                <div className='ProjectList-listItems'>
                    {FirstMainContainerSection}
                </div>
                <div className='Proyect-info'>
                    {SecondMainContainerSection}
                </div>
            </div>
        </section>
    );
